    ...
    <div className="modal-overlay" style={{
      ...
      display: 'flex', alignItems: 'center', justifyContent: 'center'
        ...
        <div className="modal-content" style={{
          background: 'white', color: '#333', padding: '0', borderRadius: '12px',
          ...
          <div className="modal-header" style={{
            ...
            <h3 style={{ margin: 0, color: '#1a1a1a' }}>Account Settings</h3>
          ...
          <div className="modal-body" style={{ padding: '2rem' }}>
            ...
            {activeTab === 'profile' ? (
              <form onSubmit={handleProfileUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 500, color: '#475569' }}>Full Name</label>
                  <input 
                    type="text" 
                    value={name} 
                    onChange={(e) => setName(e.target.value)}
                    style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', color: '#1e293b', background: '#fff' }}
                  />
                </div>
                <div>
              ...
              <form onSubmit={handlePasswordReset} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 500, color: '#475569' }}>Current Password</label>
                  <input 
                    type="password" 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 500, color: '#475569' }}>New Password</label>
                  <input 
                    type="password" 
                    value={passwords.new} 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', fontWeight: 500, color: '#475569' }}>Confirm New Password</label>
                  <input 
                    type="password" 
